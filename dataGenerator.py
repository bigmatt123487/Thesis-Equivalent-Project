...
classes = [
    ...
    {"name": "CIST 2100", "description": "ORGANIZATIONS, APPLICATIONS AND TECHNOLOGY", "application": "neither"},
    {"name": "CIST 3110", "description": "INFORMATION TECHNOLOGY ETHICS", "application": "application"},
    {"name": "MATH 1950", "description": "CALCULUS", "application": ""},
    {"name": "CSCI 2030", "description": "MATHEMATICAL FOUNDATIONS OF COMPUTER SCIENCE", "application": ""},
    {"name": "CSCI 2040", "description": "INTRODUCTION TO MATHEMATICAL PROOFS", "application": ""},
    {"name": "MATH 2050", "description": "APPLIED LINEAR ALGEBRA", "application": ""},
    {"name": "CIST 2500", "description": "INTRODUCTION TO APPLIED STATISTICS FOR IS&T", "application": ""},
    {"name": "CSCI 3320", "description": "DATA STRUCTURES", "application": ""},
    {"name": "CSCI 3550", "description": "COMMUNICATION NETWORKS", "application": ""},
    ...
    {"name": "CSCI 4830", "description": "INTRODUCTION SOFTWARE ENGINEERING", "application": ""},
    {"name": "CSCI 4970", "description": "CAPSTONE PROJECT", "application": ""},
    {"name": "CSCI 4000", "description": "ASSESSMENT", "application": ""}
]
...
scheduled_classes = {year: set() for year in range(2000, 2023)}
...
# Save the excel
df.to_excel("class_schedule.xlsx", index=False, sheet_name="testData")
